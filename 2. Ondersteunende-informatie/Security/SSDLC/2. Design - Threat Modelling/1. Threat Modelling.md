...
STRIDE is een methodologie voor het identificeren van beveiligingsrisico’s in een systeem. Het staat voor #Spoofing, #Tampering, #Repudiation, #Information_Disclosure, #Denial_of_Service, en #Elevation_of_Privilege. 
...
### Risico analyse
Risicoanalyse houdt in dat de geïdentificeerde bedreigingen worden geprioritiseerd op basis van hun waarschijnlijkheid en impact. Dit helpt om te bepalen welke bedreigingen de grootste risico's vormen en dus als eerste moeten worden aangepakt.
...
Er zijn veel tools voor het maken van een threat model beschikbaar. Binnen HBO-ICT wordt voornamelijk gebruikt gemaakt van `<a href="https://learn.microsoft.com/en-us/azure/security/develop/threat-modeling-tool" target="_blank">Microsoft Threat Modeling Tool</a>`. Een alternatief is `a href="https://owasp.org/www-project-threat-dragon/" target="_blank">OWASP Threat Dragon</a>`
