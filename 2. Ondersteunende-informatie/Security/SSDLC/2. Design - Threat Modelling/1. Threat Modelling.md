...
Meer over de risico analyse is te vinden in 
### Mitigatieplanning
...
Er zijn veel tools voor het maken van een threat model beschikbaar. Binnen HBO-ICT wordt voornamelijk gebruikt gemaakt van [Microsoft Threat Modeling Tool](https://learn.microsoft.com/en-us/azure/security/develop/threat-modeling-tool).  Een uitleg van deze tool is te vinden in het technische ontwerp bijlage 2 (insert link hier) Een alternatief is [OWASP Threat Dragon](https://owasp.org/www-project-threat-dragon/). 

`<a href="https://learn.microsoft.com/en-us/azure/security/develop/threat-modeling-tool">Test</a>`

`<a external href="https://learn.microsoft.com/en-us/azure/security/develop/threat-modeling-tool">Test</a>`
## Begrippenlijst
